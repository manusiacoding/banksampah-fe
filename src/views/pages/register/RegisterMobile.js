                        ...
                        <CCardBody>
                            <CForm>
                                ...
                                <div className="text-center mb-4 mt-3">
                                    <p>
                                        Investasi <span className="text-success">Hijau</span> Untuk
                                        Masa Depan Bersama
                                    </p>
                                </div>
                                ...
                                <div className="d-flex mb-2">
                                    <p className="text-medium-emphasis">
                                        Sudah Punya Akun?{' '}
                                        <span className="text-success fw-bold">Login Sekarang</span>
                                    </p>
                                </div>
                                <div className="d-grid gap-2">
                                    <CButton
                                        color="success"
                                        style={{ backgroundColor: '#e9f3ff', color: '#2eb85c' }}
                                    >
                                        Daftar
                                    </CButton>
                                </div>

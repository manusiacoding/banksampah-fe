...
import { cilAddressBook, cilLockLocked, cilPhone, cilSync, cilUser } from '@coreui/icons'
            ...
            <CRow className="min-vh-100">
                ...
                <CCol className="login-section">
                    <div className="w-100 text-center">
                        ...
                        <h5 className="mt-2 mb-5 title-login">Selamat Datang di Bank Sampah</h5>
                    </div>
                    <div className="w-100 mt-3 px-5">
                        <CForm className="w-100">
                            ...
                            <CInputGroup className="mb-3">
                                ...
                                <CFormInput placeholder="Nama" autoComplete="fullname" />
                            </CInputGroup>
                            <CInputGroup className="mb-3">
                                <CInputGroupText>
                                    <CIcon icon={cilPhone} />
                                </CInputGroupText>
                                <CFormInput placeholder="Nomor Ponsel" autoComplete="phone" />
                            </CInputGroup>
                            <CInputGroup className="mb-3">
                                <CInputGroupText>
                                    <CIcon icon={cilUser} />
                            ...
                            <CRow>
                                <CCol className="ml-1 d-flex justify-content-start">
                                    <p style={{ fontFamily: 'Poppins' }}>
                                        Sudah punya akun?{' '}
                                        <span className="register-paragraph">Login Sekarang</span>
                                    </p>
                                </CCol>
                                {/* <CCol className="mr-1 d-flex justify-content-end">
                                    <p
                                        className="register-paragraph"
